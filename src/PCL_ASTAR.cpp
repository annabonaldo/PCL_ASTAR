...
void StartViewer(pcl::PointCloud<pcl::PointXYZ>::Ptr base_cloud)
{
  pcl::PointCloud<pcl::PointXYZRGB>::Ptr rgb_cloud(new pcl::PointCloud<pcl::PointXYZRGB>()) ;
  pcl::copyPointCloud(*base_cloud,*rgb_cloud);

  pcl::visualization::CloudViewer viewer("Cloud Viewer");

  //blocks until the cloud is actually rendered
  viewer.showCloud(rgb_cloud);
  //rgb_cloud->points.at(0), rgb_cloud->points.at(222)); 
  ...
  main ()
{
  ...
  std::string FILE = IOmanager::FILE_cat; 
  //-------------------

  pcl::PointCloud<pcl::PointXYZ>::Ptr cloud (new pcl::PointCloud<pcl::PointXYZ>);
  pcl::io::loadPCDFile (FILE, *cloud);
  PointCloudGraph g = PointCloudGraph(cloud); 
  g.ComputeGraph(NEIGHBORHOOD_size); 
  StartViewer(cloud); 
  return 0;
}
...
main (int argc, char** argv)
{
  ...
  //-------------------
  pcl::io::loadPCDFile (FILE, *basic_cloud_ptr);
